...
export const routes: Routes = [
  ...
  {
    // The ebook reader. See DOCS/features/EBOOK_READER_II.md.
    path: 'reader2',
    loadComponent: () => import('./reader2/reader-shell.component').then(m => m.ReaderShellComponent),
    canActivate: [authGuard]
  },
  {
    // Reader I is retired. Its path stays as a redirect so a bookmark, a pinned
    // tab or an old link still lands on the reader rather than on a dead route.
    path: 'reader',
    redirectTo: 'reader2',
    pathMatch: 'full'
  },
